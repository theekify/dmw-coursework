...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO applications (app_full_name, app_email, app_phone, app_address, app_linkedin_link, app_github_link, app_cv_file) 
            VALUES (?, ?, ?, ?, ?, ?, ?)";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("sssssss", $app_full_name, $app_email, $app_phone, $app_address, $app_linkedin_link, $app_github_link, $app_cv_file);
